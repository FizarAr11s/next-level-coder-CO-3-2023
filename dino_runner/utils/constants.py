...
RUNNING_HAMMER = [
    pygame.image.load(os.path.join(IMG_DIR, "Dino/DinoRun1Hammer2.png")),
...
DEAD_BIRD = pygame.image.load(os.path.join(IMG_DIR, 'Other/Deadbird.png'))
